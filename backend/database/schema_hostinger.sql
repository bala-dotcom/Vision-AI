-- Vision AI Database Schema for Hostinger
-- Use this file if importing into an existing database in Hostinger phpMyAdmin
-- The database should already be created in Hostinger hPanel before importing this
